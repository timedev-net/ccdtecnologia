...
- [x] Adicionar os adaptadores PostgreSQL e S3.
- [x] Configurar seleção de banco e storage no Payload.
- [x] Configurar saída standalone e exemplo de ambiente.
- [x] Ajustar o build Docker para pnpm 11 e aprovar os binários nativos necessários.
...
- [x] Inicializar o schema do PostgreSQL provisionado vazio no primeiro boot.
