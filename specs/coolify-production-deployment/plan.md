...
11. Inicializar o schema do PostgreSQL somente quando a instalação ainda não possui a tabela `users`, mantendo o banco provisionado vazio funcional no primeiro boot.
